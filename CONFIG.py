...
DAYS = {
  ...
  "2": [
    ...
    ("8.25.1", 8, 25),
    ("8.35.2", 8, 35),
    ("2.10.11", "TA-degree", 10),
    ("2.10.21", "TA-fewer", 10),
    ("2.10.31", "TA-eyeball", 10)
  ],
  "3": [
    ("2.5.3", 2, 5),
    ("4.5.3", 4, 5),
    ...
    ("8.30.1", 8, 30),
    ("8.40.1", 8, 40),
    ("2.10.12", "TA-degree", 10),
    ("2.10.22", "TA-fewer", 10),
    ("2.10.32", "TA-eyeball", 10)
  ],
  "4": [
    ("2.5.4", 2, 5),
    ("4.5.4", 4, 5),
  ...
  "5": [
    ...
    ("8.20.7", 8, 20),
    ("8.35.3", 8, 35),
    ("2.10.14", "TA-degree", 10),
    ("2.10.24", "TA-fewer", 10),
    ("2.10.34", "TA-eyeball", 10)
  ],
  "round1": [
    ("16.10.1", 16, 10),
    ("16.10.2", 16, 10),
